...
(function (global) {
  ...
  const STRINGS = {
    en: {
      ...
      "analysis.sourceLi2": "<strong>Waste type shares (organic, plastic, paper, metal):</strong> Based on typical MSW composition for Dhaka and similar cities (high organic fraction; plastic and paper significant; metal smaller).",
    ...
    bn: {
      ...
      "analysis.sourceLi2": "<strong>বর্জ্যের ধরনের অংশ (জৈব, প্লাস্টিক, কাগজ, ধাতু):</strong> ঢাকা ও অনুরূপ শহরের সাধারণ MSW গঠনের ভিত্তিতে (বেশি জৈব অংশ; প্লাস্টিক ও কাগজ উল্লেখযোগ্য; ধাতু কম)।",
  ...
  const ZONE_ANALYSIS = {
    en: [
      { id: 1, name: "North Zone", dailyTonnes: 780, dominant: "Organic (kitchen & market refuse)", secondary: "Plastic packaging", composition: { organic: 67, plastic: 18, paper: 10, metal: 5 }, recyclePercent: 20, recycleTonnes: 156, note: "Residential wards and local markets—high food waste." },
      { id: 2, name: "South Zone", dailyTonnes: 720, dominant: "Organic waste", secondary: "Plastic & single-use items", composition: { organic: 64, plastic: 19, paper: 11, metal: 6 }, recyclePercent: 19, recycleTonnes: 137, note: "Mixed residential; riverside and transport corridors add plastic litter." },
      { id: 3, name: "East Zone", dailyTonnes: 910, dominant: "Plastic & composite packaging", secondary: "Organic (street food & markets)", composition: { organic: 57, plastic: 24, paper: 12, metal: 7 }, recyclePercent: 22, recycleTonnes: 200, note: "Higher commercial & light industrial activity—more packaging waste." },
      { id: 4, name: "West Zone", dailyTonnes: 650, dominant: "Organic waste", secondary: "Paper & cardboard", composition: { organic: 64, plastic: 17, paper: 13, metal: 6 }, recyclePercent: 18, recycleTonnes: 117, note: "Mixed residential; some wholesale paper/cardboard from trade." },
      { id: 5, name: "Central Zone", dailyTonnes: 1140, dominant: "Paper & plastic (offices, shops, hotels)", secondary: "Organic (restaurants & street vendors)", composition: { organic: 58, plastic: 22, paper: 14, metal: 6 }, recyclePercent: 24, recycleTonnes: 274, note: "CBD and dense services—high throughput of packaged goods and food service waste." }
    ],
    bn: [
      { id: 1, name: "উত্তর জোন", dailyTonnes: 780, dominant: "জৈব (রান্নাঘর ও বাজারের বর্জ্য)", secondary: "প্লাস্টিক প্যাকেজিং", composition: { organic: 67, plastic: 18, paper: 10, metal: 5 }, recyclePercent: 20, recycleTonnes: 156, note: "আবাসিক ওয়ার্ড ও স্থানীয় বাজার—খাদ্যজাত বর্জ্য বেশি।" },
      { id: 2, name: "দক্ষিণ জোন", dailyTonnes: 720, dominant: "জৈব বর্জ্য", secondary: "প্লাস্টিক ও একক ব্যবহারের জিনিস", composition: { organic: 64, plastic: 19, paper: 11, metal: 6 }, recyclePercent: 19, recycleTonnes: 137, note: "মিশ্র আবাসিক; নদীতীর ও পরিবহন পথে প্লাস্টিক ছড়িয়ে পড়ে।" },
      { id: 3, name: "পূর্ব জোন", dailyTonnes: 910, dominant: "প্লাস্টিক ও কম্পোজিট প্যাকেজিং", secondary: "জৈব (ফুটপাতের খাবার ও বাজার)", composition: { organic: 57, plastic: 24, paper: 12, metal: 7 }, recyclePercent: 22, recycleTonnes: 200, note: "বেশি বাণিজ্যিক ও হালকা শিল্প কার্যক্রম—প্যাকেজিং বর্জ্য বেশি।" },
      { id: 4, name: "পশ্চিম জোন", dailyTonnes: 650, dominant: "জৈব বর্জ্য", secondary: "কাগজ ও কার্ডবোর্ড", composition: { organic: 64, plastic: 17, paper: 13, metal: 6 }, recyclePercent: 18, recycleTonnes: 117, note: "মিশ্র আবাসিক; পাইকারি কাগজ/কার্ডবোর্ড কিছু।" },
      { id: 5, name: "কেন্দ্রীয় জোন", dailyTonnes: 1140, dominant: "কাগজ ও প্লাস্টিক (অফিস, দোকান, হোটেল)", secondary: "জৈব (রেস্তোরাঁ ও ফুটপাতের বিক্রেতা)", composition: { organic: 58, plastic: 22, paper: 14, metal: 6 }, recyclePercent: 24, recycleTonnes: 274, note: "সিবিডি ও ঘন সেবা—প্যাকেজকৃত পণ্য ও খাদ্যসেবা বর্জ্য বেশি।" }
    ]
  };
